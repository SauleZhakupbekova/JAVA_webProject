...
<div id="container">
    ...
    <main>
        <section class="content">
            ...
            <div class="main">
                <h2>Please choose required disciplines for creating new term and click on the button "Create".</h2>
                <div class="form_cm">
                    <form action="/newTerm" method="post">
                        <div class="line5">
                            <div>Duration (weeks)</div>
                            <label>
                                <input name="duration" type="text" value="24 weeks">
                            </label>
                        </div>
                        <div class="line5">
                            <div>Disciplines per term</div>
                            <label>
                        ...
                        <input class="button_cm_term" type="submit" value="Create">
                    </form>
                </div>
            </div>
        </section>
